      ...
      <Card className="overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
        <div className="relative w-full h-64 md:h-96">
          ...
          <div className="absolute bottom-0 left-0 p-6 md:p-8">
            <h1 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-2 shadow-sm">
              Our Engagement Party
            </h1>
            <p className="text-lg md:text-xl text-primary-foreground/90 shadow-sm">
              {date}
            </p>
          </div>
        </div>
        ...
        <CardFooter className="flex flex-col sm:flex-row items-center gap-4 p-6 bg-card/50">
          <Button size="lg" className="w-full sm:w-auto" asChild>
            ...
            >
              ...
              <Icon
                ...
                data-ai-hint="partiful invitation link"
              />
            </a>
          </Button>
          <Button size="lg" className="w-full sm:w-auto" asChild>
